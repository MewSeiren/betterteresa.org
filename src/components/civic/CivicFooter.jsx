      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 border-b border-white/15 pb-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            ...
            <a href="https://github.com/betterteresa/betterteresa.org" target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center gap-2 rounded-lg border border-white/20 px-4 py-2.5 text-sm font-bold text-white transition hover:bg-white/10"><Github size={16} /> github.com/betterteresa/betterteresa.org</a>
          </div>
        </div>
        <div className="mt-6 flex flex-wrap justify-between gap-3 text-xs text-white/45">
          ...
          <p>Open source on GitHub · github.com/betterteresa/betterteresa.org · Sources: Municipality of Teresa · COA · DBM</p>
        </div>
      </div>
    </footer>
  );
