  ...
  return (
    <section id="glance" className="rounded-2xl border border-slate-200 bg-[#f8f9fa] p-6 sm:p-8">
      <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
        <div>
          <p className="text-xs font-bold uppercase tracking-[.2em] text-[#1a73e8]">Teresa at a Glance</p>
          <h2 className="mt-2 text-3xl font-black tracking-tight text-[#0a1a35]">A first-class municipality in Rizal</h2>
        ...
        <div className="relative overflow-hidden rounded-xl border border-slate-200">
          ...
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#0a1a35]/85 via-[#0a1a35]/40 to-transparent px-4 py-3">
            <p className="text-xs font-bold uppercase tracking-wider text-white">Teresa Municipal Hall</p>
