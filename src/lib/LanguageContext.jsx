...
const dict = {
  en: {
    ...
    'tm.eyebrow': 'Tourism', 'tm.title': 'Explore Teresa & Rizal', 'tm.inTeresa': 'In Teresa', 'tm.nearby': 'Nearby in Rizal Province',
    'tm.desc': 'Teresa sits at the foothills of the Sierra Madre — a quiet agricultural town with scenic highland views, a heritage parish, and easy access to the Rizal Province\u2019s best-known destinations.',
  ...
  fil: {
    ...
    'tm.eyebrow': 'Turismo', 'tm.title': 'Tuklasin ang Teresa at Rizal', 'tm.inTeresa': 'Sa Teresa', 'tm.nearby': 'Malapit sa Lalawigan ng Rizal',
    'tm.desc': 'Nasa paanan ng Sierra Madre ang Teresa — isang tahimik na agricultural na bayan na may magagandang highland views, heritage parish, at madaling access sa mga kilalang destinasyon ng Lalawigan ng Rizal.',
